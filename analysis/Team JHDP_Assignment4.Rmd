...
In this section, our goal is to see the different types of jobs such as full-time, part-time, grad roles, internships and casual jobs. The changes in demand to these job types will vastly differ compared to a couple of months ago, but it will be interesting to see which job type increased in demand.
