...
The other data source that was also utilised in this report is a cost of living dataset from [Numbeo](https://www.numbeo.com/cost-of-living/rankings.jsp?title=2018). It is a crowd-source global database with quality of life information. From the [website’s term of use](https://www.numbeo.com/common/terms_of_use.jsp), it is mentioned that use, reuse, and distribution of Numbeo’s content are allowed. Hence, the data can be used legally in this report. Furthermore, the table of Cost of Living Index by City 2018 was scraped using the rvest and polite packages.
...
knitr::include_graphics(here::here("data/before.png"))
```
...
knitr::include_graphics(here::here("data/after.png"))
```
...
# Acknowledgements
The following R packages were used to produce this report: tidyverse [@Rtidyverse], readr [@Readr], kableExtra [@Rkable], ggplot2 [@Rggplot2],lubridate [@Rlubridate],tidyr [@Rtidyr], glue [@Rglue], naniar [@Rnaniar], polite[@Rpolite], vest [@Rvest], xml [@Rxml], forcats [@Rforcats], bookdown[@Rbookdown]
