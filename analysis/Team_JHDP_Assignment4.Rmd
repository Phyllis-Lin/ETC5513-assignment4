...
According to @davidlasswell, when searching for a job, cost of living should be taken into account. It also relates to the question whether the salary of the job would be enough to cover the living cost in a particular state. Therefore, in this subsection, we would observe the living cost in the major cities in Australia with more job positions available.  
...
Figure \ref{fig:map} shows that Sydney was found to be the city with the highest living cost, followed by Melbourne, and Queensland. Western Australia and Tasmania had a lower living cost compared to those cities. The figure also conveys that Adelaide was the city with the lowest living cost in Australia. 
